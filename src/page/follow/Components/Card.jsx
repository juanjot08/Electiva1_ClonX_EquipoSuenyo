    ...
    return (
        <>
            <div id="card">
                ...
                <div id="card_actions">
                    <LargeButton label={isFollowed ? "Siguiendo" : "Seguir"} styleType="secondary" customClass="card_largebutton_text" />
                    <IconButton icon={() => ThreeDotsIconSVG({ width: "26.250px", height: "26.250px" })} />
                </div>
